...
from main.views import show_main, create_mood_entry, show_xml, add_mood_entry_ajax
from main.views import show_main, create_mood_entry, show_xml, show_json, add_mood_entry_ajax
